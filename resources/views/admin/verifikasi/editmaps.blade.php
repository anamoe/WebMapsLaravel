    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{url('datajalan',$id)}}" method="POST" id="edit" enctype="multipart/form-data">
                ...
                <input type="hidden" value="{{$data->kecepatan}}" class="form-control" name="kecepatan" id="kecepatans" placeholder=" ">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        <img class="img" id="loadfotoadd" src="{{url('public/foto_laporan/'.$data->foto_laporan)}}" alt="Foto Thumbnail" style=" height:50%; width:50%;">
